...
2. Explore KPI cards on the first page for a quick overview

3. Navigate to Campaign Performance Table to analyze detailed metrics

4. Go to Top Ads page to see the best performing ads by CTR and ROI

5. Use Platform Comparison charts to evaluate Facebook vs Instagram performance

6. Use Time Trend Analysis to observe performance over time and identify trends
